# -*- coding: utf-8 -*-
#
# Django Fancy Cronfield documentation build configuration file, created by
...
project = u'Django Fancy Cronfield'
copyright = u'2015, Saeed Salehian'
author = u'Saeed Salehian'
...
release = fancy_cronfield.__version__
...
htmlhelp_basename = 'DjangoFancyCronfielddoc'
